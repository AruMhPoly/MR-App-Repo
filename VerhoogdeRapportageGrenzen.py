                ...
                for x in range(Pages[0],Pages[1]):
                    ...
                    for x in range(0,len(Pos)-1):
                        for i, line in enumerate(lines[Pos[x]:Pos[x+1]]):
                            if "verhoogde rapportagegrens" in line or "Bij deze gaschromatografische" in line:
...
PC = r"P:\2023\23194 bodemonderzoek Zandkreeksluis\V1\09 Laboratorium\02 Certificaten\PDF"
MB = r"P:\2023\23194 bodemonderzoek Zandkreeksluis\V1\09 Laboratorium\03 Toetsingen\EXCEL\TSC__Output_BoToVa.xlsx"
MP = r"P:\2023\23194 bodemonderzoek Zandkreeksluis\V1\09 Laboratorium\03 Toetsingen\EXCEL\TSC__Output_PFAS.xlsx"
PS= r"P:\2023\23194 bodemonderzoek Zandkreeksluis\V1\09 Laboratorium\03 Toetsingen\EXCEL"
